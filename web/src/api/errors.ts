...
export type Operation =
  ...
  | "listAttachments" | "attachmentContent" | "messageMarkdownContent" | "uploadFile"
...
function formatHttpFailure(failure: Extract<ApiError, { _tag: "ApiHttpError" }>, context: ApiErrorContext): string {
  ...
  if (status === 404 && operation === "messageMarkdownContent") return "This Markdown file is no longer available at that path."
